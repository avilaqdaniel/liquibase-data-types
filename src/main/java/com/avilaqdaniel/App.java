...
public class App {
    ...
    public static void main(String[] args) {
        // Initialize Liquibase and run migrations
        try {
                ...
                try {
                    ...
                    for (AbstractJdbcDatabase databaseInstance : databases) {
                        try {
                            ...
                            String databaseType = dataType.toDatabaseDataType(database).toString();
            ...
            } // Set up Liquibase configuration and database connection
            // Run migrations
        } catch (Exception e) {
            e.printStackTrace();
        }
